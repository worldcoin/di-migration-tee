...
let
  # The same rust-toolchain.toml cargo already uses, so a channel bump moves the enclave
  # and the host together instead of drifting. rust-overlay carries the component hashes,
