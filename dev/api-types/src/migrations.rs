...
///
/// Bounds the request body and the decompression ceiling alike: one is what arrives, the other
/// what gets allocated, and gzip can expand ~1000:1 between them. Not derived from a measured
/// PCP — pick a real number once `iris.tar` + `face.tar` sizes are known.
