//! Runtime configuration, read once at boot so a misconfigured host fails to start.

use std::env;

use di_dev_api_types::{MAX_PCP_BYTES, MAX_REQUEST_BYTES};
...
impl Environment {
    ...
    /// # Panics
    ///
    /// Panics when any variable is unset or does not parse.
    #[must_use]
